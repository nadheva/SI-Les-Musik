<x-app-layout>
    <main id="main" class="main">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="{{ route('alat-musik.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title card-title" id="tambahRoleLabel">Tambah Alat Musik</h5>
                    ...
                    <div class="modal-body">
                        <form class="row g-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control"  name="foto" placeholder="Masukkan Nama" value="{{old('foto')}}" required>
                              </div>
                            <div class="form-group">
    ...
    <div class="modal fade" id="editAlatMusik-{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="editRoleLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" action="{{ url('alat-musik-update', $i->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="row g-3">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="col-form-label">Foto : </label>
                                <input type="file" class="form-control"  name="foto" placeholder="Masukkan Nama" value="{{$i->foto}}" required>
                              </div>
                              <div class="form-group">
                                <label class="col-form-label">Deskripsi : </label>
