...
<p class="fs-sm">
Berikut ini adalah tanda terima pembayaran <strong>$312.00</strong> (IDR) Sekolah Musik Sincere.
</p>
...
<div class="text-muted mb-2">Tanggal Pembayran</div>
...
<tbody>
<tr>
<td class="px-0">{{$transaksi->reservasi->course->judul}}/td>
<td class="text-end px-0">{{$transaksi->reservasi->course->harga}}</td>
</tr>
</tbody>
</table>
<div class="mt-5">
...
<span>{{$transaksi->grand_total}}</span>
</div>
<div class="d-flex justify-content-end">
...
<h5 class="text-success">{{$transaksi->grand_total}}</h5>
</div>
</div>
</div>
