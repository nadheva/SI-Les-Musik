...
class AlatMusikSeeder extends Seeder
{
    ...
    public function run(): void
    {
        AlatMusik::create([
            'nama' => 'Piano Klasik',
            'foto' => 'storage/perangkat/piano-klasik.jpg',
        ...
        AlatMusik::create([
            'nama' => 'Piano Pop',
            'foto' => 'storage/perangkat/piano-pop.jpeg',
        ...
        AlatMusik::create([
            'nama' => 'Gitar Klasik',
            'foto' => 'storage/perangkat/gitar-klasik.jpeg',
        ...
        AlatMusik::create([
            'nama' => 'Gitar Elektrik',
            'foto' => 'storage/perangkat/gitar-elektrik.jpeg',
        ...
        AlatMusik::create([
            'nama' => 'Bass',
            'foto' => 'storage/perangkat/bass.webp',
        ...
        AlatMusik::create([
            'nama' => 'Drum',
            'foto' => 'storage/perangkat/drum.webp',
        ...
        AlatMusik::create([
            'nama' => 'Keyboard',
            'foto' => 'storage/perangkat/keyboard.jpg',
        ...
        AlatMusik::create([
            'nama' => 'Biola',
            'foto' => 'storage/perangkat/biola.jpg',
        ...
        AlatMusik::create([
            'nama' => 'Saxophone',
            'foto' => 'storage/perangkat/saxophone.jpg',
        ...
        AlatMusik::create([
            'nama' => 'Flute',
            'foto' => 'storage/perangkat/flute.webp',
